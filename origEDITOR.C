...
void draw_shape_panel()
{
   ...
   setcolor(WHITE);
   outtextxy(535,45,"Fill Rect.");
   outtextxy(535,75,"Line");
   outtextxy(535,105,"Dot");
   outtextxy(535,135,"Ellipse");
   outtextxy(535,165,"Pencil");
   outtextxy(535,195,"Rectangle");
   outtextxy(535,225,"Erase All");
   setcolor(color);
}
